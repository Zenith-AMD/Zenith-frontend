...
const FileUpload = ({ onFileChange, file }) => {
  ...
  return (
    <div className="file-upload-wrapper">
      ...
      <a href="/sample-contracts.zip" className="download-sample-btn" download>
        <svg className="download-sample-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
